# Disaster Data Sources - Research & Inventory

Research document for disaster data sources, download status, and data gaps.

**For implemented disaster display system**: See [DISASTER_DISPLAY.md](DISASTER_DISPLAY.md) - global sources, animation, frontend

**Current inventory**: See `county-map-data/DATA_STATUS.txt` for what's already imported.

**Non-disaster sources** (census, currency, energy): See [PIPELINE_REVIEW_2026-01-07.md](PIPELINE_REVIEW_2026-01-07.md)
...
- Downloaded raw data inventory
- Download script status
- Regional/country-specific sources (not global)
- Data gaps and blocked sources
- Research on additional sources
- Historical FEMA NRI versions

For the **main disaster visualization system** with global sources (USGS earthquakes, IBTrACS storms, NOAA tsunamis, Smithsonian volcanoes, Global Fire Atlas), see [DISASTER_DISPLAY.md](DISASTER_DISPLAY.md).
